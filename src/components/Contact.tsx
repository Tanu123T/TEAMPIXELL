...
export function Contact() {
  ...
  return (
    <section ref={ref} id="contact" className="py-32 px-6 relative overflow-hidden bg-white">
      {/* Decorative blobs */}
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            <div className="space-y-6">
              ...
              <h2 className="text-5xl md:text-7xl font-bold text-[#0F2A44] leading-tight tracking-tight font-brand">
                Let's Connect <br />
            ...
            <form className="space-y-8 relative z-10" onSubmit={(e) => e.preventDefault()}>
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <select className="w-full px-6 py-4 bg-white border border-slate-100 rounded-2xl focus:outline-none focus:ring-2 focus:ring-[#0F2A44]/20 focus:border-[#0F2A44] transition-all text-[#0F2A44] font-medium appearance-none cursor-pointer">
